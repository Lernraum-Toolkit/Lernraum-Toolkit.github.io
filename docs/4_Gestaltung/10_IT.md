...
vorher ein Dozierender vielleicht in Video im Raum abgespielt hat, werden sie
...
Anordnung von Picocells[^17], die unter Sitzen angebracht werden.
...
auf der Jiscmail-Diskussionsliste[^18] der UCISA Networking Group[^19]
und der WIRELESS-ADMIN Jiscmail-Liste[^20] diskutiert.
...
Laptops oder Tablets zum Ausleihen zur Verfügung[^21], um
...
IT-Systemen; diese kann auf den UCISA Model Regulations[^22] basieren.
...
In einem Punkt scheinen sich alle Mitwirkenden des [UK Toolkits](../Referenzen.md) einig zu
...
---
[^17]: Eine Picocell ist eine kleine Basisstation, die verwendet wird, um
...
[^18]: UCISA Networking Group mailing Liste: [Link mailing Liste](http://www.jiscmail.ac.uk/cgi-bin/webadmin?A0=ucisa-ng)

[^19]: UCISA Networking Group: [Link zur Gruppe](http://www.ucisa.ac.uk/groups/ng)

[^20]: Link [zu Webseite](http://www.jiscmail.ac.uk/cgi-bin/webadmin?A0=WIRELESS-ADMIN)

[^21]: Die University of Manchester ist ein Beispiel einer Institution
...
[^22]: UCISA (2014) Model Regulations for the use of institutional IT
...
[^23]: Link [zu Webseite](http://www.makeuseof.com/tag/what-you-need-to-know-about-wireless-charging/)
